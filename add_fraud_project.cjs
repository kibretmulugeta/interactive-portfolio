...
async function addProject() {
  try {
    ...
    const newProject = {
      ...
      description: 'Developed a real-time graph-based anomaly detection pipeline using Graph Neural Networks (GNN) and XGBoost to identify fraudulent transactions across millions of nodes with sub-second latency.',
      image: '/assets/images/fraud_detection.png',
      tags: ['Graph Neural Networks', 'XGBoost', 'Anomaly Detection', 'PyTorch Geometric'],
      liveUrl: '#',
    ...
    if (!exists) {
        ...
        await config.save();
        console.log('Successfully added Fraud Detection project!');
    } else {
